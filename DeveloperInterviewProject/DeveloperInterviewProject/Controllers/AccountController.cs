...
using DeveloperInterviewProject.Models;
using DeveloperInterviewProject.Providers;
using DeveloperInterviewProject.Results;

namespace DeveloperInterviewProject.Controllers
{
    [Authorize]
